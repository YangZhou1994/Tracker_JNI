...
#include <jni.h>
/* Header for class org_cripac_isee_alg_pedestrian_tracking_ISEEBasicTracker */

#ifndef _Included_org_cripac_isee_alg_pedestrian_tracking_ISEEBasicTracker
#define _Included_org_cripac_isee_alg_pedestrian_tracking_ISEEBasicTracker
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Class:     org_cripac_isee_alg_pedestrian_tracking_ISEEBasicTracker
 * Method:    getTargets
 * Signature: (J)[Lorg/cripac/isee/alg/pedestrian/tracking/Trajectory;
 */
